...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  IsolateNatives__processWorkerMessage_closure: {
    "^": "Closure:58;entryPoint_0,args_1,message_2,isSpawnUri_3,startPaused_4,replyTo_5",
    call$0: [function() {
  ...
  _NativeJsSendPort_send_closure: {
    "^": "Closure:58;box_0,this_1,shouldSerialize_2",
    call$0: [function() {
      var t1, t2;
...
["_js_helper", "dart:_js_helper", , H, {
  ...
  invokeClosure_closure1: {
    "^": "Closure:58;closure_3,arg1_4,arg2_5",
    call$0: function() {
  ...
  invokeClosure_closure2: {
    "^": "Closure:58;closure_6,arg1_7,arg2_8,arg3_9",
    call$0: function() {
  ...
  invokeClosure_closure3: {
    "^": "Closure:58;closure_10,arg1_11,arg2_12,arg3_13,arg4_14",
    call$0: function() {
...
["dart.async", "dart:async", , P, {
  ...
  _Future__asyncComplete_closure: {
    "^": "Closure:58;this_0,coreFuture_1",
    call$0: [function() {
  ...
  _Future__asyncCompleteError_closure: {
    "^": "Closure:58;this_0,error_1,stackTrace_2",
    call$0: [function() {
  ...
  _Future__propagateToListeners_handleValueCallback: {
    "^": "Closure:74;box_1,listener_3,sourceValue_4,zone_5",
    call$0: function() {
      var e, s, exception, t1;
      try {
  ...
  _cancelAndError_closure: {
    "^": "Closure:58;future_0,error_1,stackTrace_2",
    call$0: [function() {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 79, 17, 18],
  ...
  _rootHandleUncaughtError_closure: {
    "^": "Closure:58;error_0,stackTrace_1",
    call$0: function() {
...
["dart.collection", "dart:collection", , P, {
  ...
  _defaultEquals: [function(a, b) {
    return J.$eq(a, b);
  }, "call$2", "_defaultEquals$closure", 4, 0, 42],
  _defaultHashCode: [function(a) {
    return J.get$hashCode$(a);
  }, "call$1", "_defaultHashCode$closure", 2, 0, 43, 44],
...
["dart.core", "dart:core", , P, {
  ...
  }, "call$2", "Comparable_compare$closure", 4, 0, 45],
  ...
  Uri: {
    ...
    static: {"^": "Uri__SPACE,Uri__DOUBLE_QUOTE,Uri__NUMBER_SIGN,Uri__PERCENT,Uri__ASTERISK,Uri__PLUS,Uri__DOT,Uri__SLASH,Uri__ZERO,Uri__NINE,Uri__COLON,Uri__LESS,Uri__GREATER,Uri__QUESTION,Uri__AT_SIGN,Uri__UPPER_CASE_A,Uri__UPPER_CASE_F,Uri__UPPER_CASE_Z,Uri__LEFT_BRACKET,Uri__BACKSLASH,Uri__RIGHT_BRACKET,Uri__LOWER_CASE_A,Uri__LOWER_CASE_F,Uri__LOWER_CASE_Z,Uri__BAR,Uri__unreservedTable,Uri__unreserved2396Table,Uri__encodeFullTable,Uri__schemeTable,Uri__schemeLowerTable,Uri__subDelimitersTable,Uri__genDelimitersTable,Uri__userinfoTable,Uri__regNameTable,Uri__pathCharTable,Uri__pathCharOrSlashTable,Uri__queryCharTable", Uri__defaultPort: function(scheme) {
        ...
        firstCodeUnit = scheme.charCodeAt(0);
...
["dart.dom.html", "dart:html", , W, {
  ...
  }, "call$1", "_callAttached$closure", 2, 0, 48, 49],
  _callDetached: [function(receiver) {
    return J.detached$0$x(receiver);
  }, "call$1", "_callDetached$closure", 2, 0, 48, 49],
  ...
  }, "call$4", "_callAttributeChanged$closure", 8, 0, 50, 49, 51, 52, 53],
  ...
  _callConstructor_closure: {
    "^": "Closure:48;constructor_0,interceptor_1",
...
["dart.js", "dart:js", , P, {
  ...
  }, "call$4", "_callDartFunction$closure", 8, 0, null, 34, 54, 20, 55],
  ...
  }, "call$1", "_convertToJS$closure", 2, 0, 48, 56],
  ...
  JsObject__convertDataTree__convert: {
    "^": "Closure:48;_convertedObjects_0",
    call$1: [function(o) {
...
["html_common", "dart:html_common", , P, {
  ...
  _convertDartToNative_PrepareForStructuredClone_walk: {
    "^": "Closure:48;findSlot_5,readSlot_6,writeSlot_7",
    call$1: function(e) {
  ...
  convertNativeToDart_AcceptStructuredClone_walk: {
    "^": "Closure:48;mustCopy_4,findSlot_5,readSlot_6,writeSlot_7",
    call$1: function(e) {
...
["icon", "../../../lib/icon/icon_view.dart", , A, {
  "^": "",
  IconView: {
    "^": "PolymerElement_ChangeNotifier;_logger,_icon$__$src,_icon$__$width,_icon$__$height,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,polymer$Polymer$_polymer$_element,polymer$Polymer$_namedObservers,polymer$Polymer$_observers,polymer$Polymer$_unbound,polymer$Polymer$_unbindAllJob,polymer$Polymer$_propertyObserver,polymer$Polymer$_readied,polymer$Polymer$_jsElem,polymer$Polymer$_hasBeenAttached,polymer$Polymer$shadowRoots,polymer$Polymer$$,polymer$Polymer$_properties,polymer$Polymer$_polyfillScopeStyleCache",
    ...
    ready$0: function(receiver) {
      ...
      P.print("icon-view src changed");
      J.set$backgroundImage$x(receiver.style, C.JSString_methods.$add("url(", receiver._icon$__$src) + ")");
    },
...
["iconbutton", "../../../lib/iconbutton/icon_button.dart", , N, {
  "^": "",
  IconButton: {
    "^": "PolymerElement_ChangeNotifier0;_iconbutton$__$src,_iconbutton$__$width,_iconbutton$__$height,_iconbutton$__$togglable,_iconbutton$__$checked,_changedEventP,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,polymer$Polymer$_polymer$_element,polymer$Polymer$_namedObservers,polymer$Polymer$_observers,polymer$Polymer$_unbound,polymer$Polymer$_unbindAllJob,polymer$Polymer$_propertyObserver,polymer$Polymer$_readied,polymer$Polymer$_jsElem,polymer$Polymer$_hasBeenAttached,polymer$Polymer$shadowRoots,polymer$Polymer$$,polymer$Polymer$_properties,polymer$Polymer$_polyfillScopeStyleCache",
    get$preventDispose: function(receiver) {
      return true;
    },
    polymerCreated$0: function(receiver) {
      var t1;
      A.Polymer.prototype.polymerCreated$0.call(this, receiver);
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(receiver, "click", false), [null]);
  ...
  IconListButton: {
    "^": "PolymerElement_ChangeNotifier1;_iconbutton$_submenu,_iconbutton$__$src,_iconbutton$__$width,_iconbutton$__$height,_iconbutton$__$open,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,polymer$Polymer$_polymer$_element,polymer$Polymer$_namedObservers,polymer$Polymer$_observers,polymer$Polymer$_unbound,polymer$Polymer$_unbindAllJob,polymer$Polymer$_propertyObserver,polymer$Polymer$_readied,polymer$Polymer$_jsElem,polymer$Polymer$_hasBeenAttached,polymer$Polymer$shadowRoots,polymer$Polymer$$,polymer$Polymer$_properties,polymer$Polymer$_polyfillScopeStyleCache",
    get$preventDispose: function(receiver) {
      return true;
    },
    polymerCreated$0: function(receiver) {
    ...
    ready$0: function(receiver) {
      ...
      A.Polymer.prototype.ready$0.call(this, receiver);
      t1 = receiver._iconbutton$_submenu;
    ...
    leftView$0: function(receiver) {
      J.remove$0$ax(receiver._iconbutton$_submenu);
    },
    addItem$1: function(receiver, arg_item) {
      return J.addItem$1$x(receiver._iconbutton$_submenu, arg_item);
    },
    indexOf$1: function(receiver, arg_item) {
      return J.indexOf$1$asx(receiver._iconbutton$_submenu, arg_item);
    },
    set$src: function(receiver, value) {
      receiver._iconbutton$__$src = this.notifyPropertyChange$3(receiver, C.Symbol_src, receiver._iconbutton$__$src, value);
    },
    ...
    static: {IconListButton$created: function(receiver) {
        ...
        t4 = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
        t5 = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
        receiver._iconbutton$_submenu = t1;
        receiver._iconbutton$__$src = "";
        receiver._iconbutton$__$width = 24;
        receiver._iconbutton$__$height = 24;
  ...
  IconOptionsButton: {
    "^": "PolymerElement_ChangeNotifier2;_iconbutton$_submenu,_iconbutton$__$src,_iconbutton$__$width,_iconbutton$__$height,_iconbutton$__$togglable,_iconbutton$__$checked,_iconbutton$__$open,_selectedEventP,_deselectedEventP,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,polymer$Polymer$_polymer$_element,polymer$Polymer$_namedObservers,polymer$Polymer$_observers,polymer$Polymer$_unbound,polymer$Polymer$_unbindAllJob,polymer$Polymer$_propertyObserver,polymer$Polymer$_readied,polymer$Polymer$_jsElem,polymer$Polymer$_hasBeenAttached,polymer$Polymer$shadowRoots,polymer$Polymer$$,polymer$Polymer$_properties,polymer$Polymer$_polyfillScopeStyleCache",
    get$preventDispose: function(receiver) {
      return true;
    },
    polymerCreated$0: function(receiver) {
    ...
    addItem$1: function(receiver, arg_item) {
      var ret = J.addItem$1$x(receiver._iconbutton$_submenu, arg_item);
      if (ret)
        ;
      return ret;
    },
...
["menubar", "../../../lib/menubar/menubar.dart", , S, {
  ...
  Menubar: {
    ...
    indexOf$1: function(receiver, arg_item) {
      var t1 = new W._ChildrenElementList(receiver, receiver.children);
      return t1.indexOf$1(t1, arg_item);
    },
  ...
  MenuItem: {
    "^": "PolymerElement_ChangeNotifier4;_menubar$__$hasicon,_menubar$__$icon,_menubar$__$heading,_iconDiv,_titleDiv,_submenu,_menubar$__$open,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,polymer$Polymer$_polymer$_element,polymer$Polymer$_namedObservers,polymer$Polymer$_observers,polymer$Polymer$_unbound,polymer$Polymer$_unbindAllJob,polymer$Polymer$_propertyObserver,polymer$Polymer$_readied,polymer$Polymer$_jsElem,polymer$Polymer$_hasBeenAttached,polymer$Polymer$shadowRoots,polymer$Polymer$$,polymer$Polymer$_properties,polymer$Polymer$_polyfillScopeStyleCache",
    get$preventDispose: function(receiver) {
      return true;
    },
    ready$0: function(receiver) {
    ...
    attached$0: function(receiver) {
      var t1, t2, t3, _el, t4;
      A.Polymer.prototype.attached$0.call(this, receiver);
      for (t1 = new W._ChildrenElementList(receiver, receiver.children), t1 = t1.toList$0(t1), t1 = H.setRuntimeTypeInfo(new H.ListIterator(t1, t1.length, 0, null), [H.getTypeArgumentByIndex(t1, 0)]), t2 = receiver._submenu, t3 = J.getInterceptor$x(t2); t1.moveNext$0();) {
        _el = t1._current;
    ...
    indexOf$1: function(receiver, arg_item) {
      return J.indexOf$1$asx(receiver._submenu, arg_item);
    },
    get$open: function(receiver) {
  ...
  SubMenu: {
    "^": "PolymerElement_ChangeNotifier5;_documentEndSubscr,_documentKeyboardSubscr,_menubar$__$show,_parent_submenu_item},triggerItems=,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,polymer$Polymer$_polymer$_element,polymer$Polymer$_namedObservers,polymer$Polymer$_observers,polymer$Polymer$_unbound,polymer$Polymer$_unbindAllJob,polymer$Polymer$_propertyObserver,polymer$Polymer$_readied,polymer$Polymer$_jsElem,polymer$Polymer$_hasBeenAttached,polymer$Polymer$shadowRoots,polymer$Polymer$$,polymer$Polymer$_properties,polymer$Polymer$_polyfillScopeStyleCache",
    get$preventDispose: function(receiver) {
      return true;
    },
    attached$0: function(receiver) {
    ...
    get$onHide: function(receiver) {
      return H.setRuntimeTypeInfo(new W._EventStream(receiver, "hide", false), [null]);
    },
  ...
  SubMenuItem: {
    "^": "SubMenuContentItem_ChangeNotifier;_menubar$__$icon,_menubar$__$heading,_menubar$__$checked,_iconDiv,_holder,menubar$SubMenuItem$_submenu,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,_menubar$__$checkable,_submenu,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,_parent_submenu,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,polymer$Polymer$_polymer$_element,polymer$Polymer$_namedObservers,polymer$Polymer$_observers,polymer$Polymer$_unbound,polymer$Polymer$_unbindAllJob,polymer$Polymer$_propertyObserver,polymer$Polymer$_readied,polymer$Polymer$_jsElem,polymer$Polymer$_hasBeenAttached,polymer$Polymer$shadowRoots,polymer$Polymer$$,polymer$Polymer$_properties,polymer$Polymer$_polyfillScopeStyleCache",
    get$preventDispose: function(receiver) {
      return true;
    },
    ready$0: function(receiver) {
      var t1, t2;
      A.Polymer.prototype.ready$0.call(this, receiver);
      t1 = receiver.menubar$SubMenuItem$_submenu;
      t2 = J.getInterceptor$x(t1);
      t2.get$triggerItems(t1).push(receiver);
    ...
    attached$0: function(receiver) {
      var t1, t2, t3, _el, t4;
      A.Polymer.prototype.attached$0.call(this, receiver);
      for (t1 = new W._ChildrenElementList(receiver, receiver.children), t1 = t1.toList$0(t1), t1 = H.setRuntimeTypeInfo(new H.ListIterator(t1, t1.length, 0, null), [H.getTypeArgumentByIndex(t1, 0)]), t2 = receiver.menubar$SubMenuItem$_submenu, t3 = J.getInterceptor$x(t2); t1.moveNext$0();) {
        _el = t1._current;
        t4 = J.getInterceptor(_el);
        if (!t4.$isSubMenuItemBase)
          ;
    ...
    leftView$0: function(receiver) {
      J.remove$0$ax(receiver.menubar$SubMenuItem$_submenu);
    },
    addItem$1: function(receiver, arg_item) {
      return J.addItem$1$x(receiver.menubar$SubMenuItem$_submenu, arg_item);
    },
    indexOf$1: function(receiver, arg_item) {
      return J.indexOf$1$asx(receiver.menubar$SubMenuItem$_submenu, arg_item);
    },
    static: {"^": "SubMenuItem__SELECTED_EVENT,SubMenuItem__changed_eventP", SubMenuItem$created: function(receiver) {
        ...
        receiver._menubar$__$icon = "";
        receiver._menubar$__$heading = "";
        receiver.menubar$SubMenuItem$_submenu = t1;
        receiver._submenu = t2;
        receiver.polymer$Polymer$_observers = [];
        receiver.polymer$Polymer$_readied = false;
        receiver.polymer$Polymer$_hasBeenAttached = false;
  ...
  SubMenuSeparaterItem: {
    "^": "SubMenuItemBase;_parent_submenu,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,polymer$Polymer$_polymer$_element,polymer$Polymer$_namedObservers,polymer$Polymer$_observers,polymer$Polymer$_unbound,polymer$Polymer$_unbindAllJob,polymer$Polymer$_propertyObserver,polymer$Polymer$_readied,polymer$Polymer$_jsElem,polymer$Polymer$_hasBeenAttached,polymer$Polymer$shadowRoots,polymer$Polymer$$,polymer$Polymer$_properties,polymer$Polymer$_polyfillScopeStyleCache",
    attached$0: function(receiver) {
      var t1;
      A.Polymer.prototype.attached$0.call(this, receiver);
      for (t1 = new W._ChildrenElementList(receiver, receiver.children), t1 = t1.toList$0(t1), t1 = H.setRuntimeTypeInfo(new H.ListIterator(t1, t1.length, 0, null), [H.getTypeArgumentByIndex(t1, 0)]); t1.moveNext$0();)
...
["observe.src.change_notifier", "package:observe/src/change_notifier.dart", , O, {
  ...
  ChangeNotifier: {
    ...
    deliverChanges$0: [function(receiver) {
      ...
      return false;
    }, "call$0", "get$deliverChanges", 0, 0, 74],
...
["observe.src.dirty_check", "package:observe/src/dirty_check.dart", , O, {
  ...
  dirtyCheckZoneSpec_wrapCallback_closure: {
    "^": "Closure:58;enqueueDirtyCheck_2,parent_3,zone_4,f_5",
    call$0: [function() {
  ...
  dirtyCheckZoneSpec_wrapUnaryCallback: {
    "^": "Closure:93;enqueueDirtyCheck_6",
    call$4: [function($self, $parent, zone, f) {
      if (f == null)
        return f;
  ...
  dirtyCheckZoneSpec_wrapUnaryCallback_closure: {
    "^": "Closure:48;enqueueDirtyCheck_7,parent_8,zone_9,f_10",
    call$1: [function(x) {
...
["observe.src.list_diff", "package:observe/src/list_diff.dart", , G, {
  ...
  ListChangeRecord: {
    ...
    toString$0: function(_) {
      return "#<ListChangeRecord index: " + this._list_diff$_index + ", removed: " + H.S(this._unmodifiableRemoved) + ", addedCount: " + this._addedCount + ">";
    },
...
["observe.src.observer_transform", "package:observe/src/observer_transform.dart", , Y, {
  ...
  ObserverTransform: {
    ...
    }, "call$1", "get$_observedCallback", 2, 0, 48, 53],
    close$0: function(_) {
...
["observe.src.path_observer", "package:observe/src/path_observer.dart", , L, {
  ...
  _PathParser: {
    ...
    parse$1: function(path) {
      ...
      for (t1 = this._pathStateMachine, t2 = codePoints.length, mode = "beforePath"; mode != null;) {
        ...
        if (c != null)
          t3 = H.Primitives_stringFromCharCodes([c]) === "\\" && this._maybeUnescapeQuote$2(mode, codePoints);
        else
          t3 = false;
        if (t3)
          continue;
  ...
  _ObservedSet: {
    ...
    }, "call$2", "get$observe", 4, 0, 95, 96, 97],
    ...
    }, "call$1", "get$_path_observer$_callback", 2, 0, 13, 98],
...
["polymer", "package:polymer/polymer.dart", , A, {
  ...
  }, "call$1", "_isObserverMethod$closure", 2, 0, 59, 60],
  ...
  _initializeLogging: function() {
    var logFlags, loggers, polymerLogger;
    ...
    if (!H.IterableMixinWorkaround_any(loggers, new A._initializeLogging_closure(logFlags))) {
      polymerLogger.set$level(C.Level_OFF_2000);
      return;
    }
    H.setRuntimeTypeInfo(new H.WhereIterable(loggers, new A._initializeLogging_closure0(logFlags)), [H.getTypeArgumentByIndex(H.setRuntimeTypeInfo(new H.IterableMixinWorkaround(), [H.getTypeArgumentByIndex(loggers, 0)]), 0)]).forEach$1(0, new A._initializeLogging_closure1());
  ...
  PolymerDeclaration: {
    ...
    createPropertyAccessors$0: function() {
      var existing, t1, t2, decl, meta, $name;
      existing = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
      for (t1 = A.query(this.type, C.QueryOptions_ijl), t1 = t1.get$iterator(t1), t2 = this._computed; t1.moveNext$0(), false;) {
        decl = t1.get$current();
  ...
  PolymerExpressions: {
    ...
    static: {"^": "PolymerExpressions_getExpression,PolymerExpressions_getBinding"}
  },
  ...
  PolymerEventBindings_getEventHandler_closure: {
    "^": "Closure:48;box_0,this_1,target_2,method_3",
    call$1: [function(e) {
  ...
  _EventBindable: {
    "^": "Bindable;_polymer$_sub,_polymer$_path",
    get$value: function(_) {
  ...
  Polymer: {
    ...
    bind$3$oneTime: function(receiver, $name, bindable, oneTime) {
      ...
      if (decl == null)
        ...
        receiver.polymer$Polymer$_polymer$_element.get$_reflect();
    ...
    }, "call$1", "get$_propertyChangeWorkaround", 2, 0, 106, 98],
    ...
    _getBindingForComputedProperty$1: function(receiver, $name) {
      receiver.polymer$Polymer$_polymer$_element.get$_computed().$index(0, $name);
      return;
    },
    createComputedProperties$0: function(receiver) {
      ...
      for (t1 = J.get$iterator$ax(computed.get$keys()), t2 = receiver.polymer$Polymer$_properties; t1.moveNext$0();) {
        $name = t1.get$current();
        try {
  ...
  Polymer_notifyPropertyChanges_closure: {
    "^": "Closure:66;this_0,newValues_1,oldValues_2,paths_3,observe_4,called_5",
    ...
    }, "call$2", null, 4, 0, null, 107, 52, "call"],
    $isFunction: true
  },
  Polymer__propertyChange_closure: {
    "^": "Closure:58;this_0,nameSymbol_1,newValue_2,oldValue_3",
    call$0: [function() {
  ...
  Polymer_observeArrayValue_closure1: {
    "^": "Closure:48;this_4,old_5,callbacks_6",
    call$1: function(changes) {
      var t1, t2, t3;
      for (t1 = J.get$iterator$ax(this.callbacks_6), t2 = this.this_4, t3 = this.old_5; t1.moveNext$0();)
        A.invoke(t2, t1.get$current(), [t3], true, null);
    },
    $isFunction: true
  },
  Polymer_bindProperty_closure: {
    "^": "Closure:58;this_0,name_1,bindableOrValue_2",
    call$0: [function() {
  ...
  Polymer_bindProperty_closure0: {
    "^": "Closure:58;this_3,name_4,bindableOrValue_5",
    call$0: [function() {
  ...
  Polymer_dispatchMethod_closure: {
    "^": "Closure:58;this_0,callbackOrMethod_1",
    call$0: [function() {
  ...
  Polymer_dispatchMethod_closure0: {
    "^": "Closure:58;this_2,callbackOrMethod_3",
    call$0: [function() {
  ...
  _hookJsPolymer_registerDart: {
    "^": "Closure:110;zone_0,originalRegister_1",
    ...
    }, "call$3", null, 6, 0, null, 108, 51, 109, "call"],
    $isFunction: true
  },
  _hookJsPolymer_registerDart_closure: {
    "^": "Closure:58;jsElem_2,name_3,type_4,extendsDecl_5",
    call$0: [function() {
      ...
      if (targetScheme.length !== 0) {
        ...
        if (t1._host != null) {
          ...
          if (t7.$eq(t6, "")) {
            ...
            targetPath = t7.startsWith$1(t6, "/") ? base._removeDotSegments$1(t6) : base._removeDotSegments$1(base._merge$2(base._path, t6));
            targetQuery = t1._query;
            if (targetQuery != null)
              ;
            else
      ...
      if (fragment != null)
        ...
        fragment = null;
      t5._rootUri = new P.Uri(targetHost, targetPort, targetPath, targetScheme, targetUserInfo, targetQuery, fragment, null, null);
  ...
  _initializeLogging_closure: {
    "^": "Closure:48;logFlags_0",
    call$1: function(logger) {
      return J.$eq(J.$index$asx(this.logFlags_0, J.get$name$x(logger)), true);
    },
    $isFunction: true
  },
  _initializeLogging_closure0: {
    "^": "Closure:48;logFlags_1",
    call$1: function(logger) {
      return !J.$eq(J.$index$asx(this.logFlags_1, J.get$name$x(logger)), true);
    },
    $isFunction: true
  },
  ...
  _PropertyAccessor: {
    ...
    }, "call$1", "get$updateValue", 2, 0, null, 53],
    get$value: function(_) {
...
["polymer_expressions", "package:polymer_expressions/polymer_expressions.dart", , T, {
  ...
  _classAttributeConverter: [function(v) {
    ...
    return t1;
  }, "call$1", "_classAttributeConverter$closure", 2, 0, 57, 61],
  _styleAttributeConverter: [function(v) {
    ...
    if (!!t1.$isMap)
      ...
      t1 = !!t1.$isIterable ? t1.join$1(v, ";") : v;
    return t1;
  }, "call$1", "_styleAttributeConverter$closure", 2, 0, 57, 61],
  ...
  PolymerExpressions_prepareBinding_closure: {
    "^": "Closure:113;this_1,identifier_2,bindExpr_3",
    call$3: [function(model, node, oneTime) {
      var t1, scope;
      t1 = this.this_1;
  ...
  PolymerExpressions_prepareBinding_closure1: {
    "^": "Closure:113;box_0,this_6,expr_7",
    call$3: [function(model, node, oneTime) {
  ...
  PolymerExpressions_prepareInstanceModel_closure0: {
    "^": "Closure:48;this_2,template_3,ident_4",
    call$1: [function(model) {
  ...
  _Binding: {
    ...
    }, "_convertAndCheck$1", "call$2$skipChanges", "call$1", "get$_convertAndCheck", 2, 3, 114, 115, 53, 116],
    get$value: function(_) {
  ...
  _Binding_open_closure: {
    ...
    }, "call$2", null, 4, 0, null, 2, 90, "call"],
    $isFunction: true
  },
  ScopeFactory: {
    "^": "Object;"
...
["polymer_expressions.eval", "package:polymer_expressions/eval.dart", , K, {
  ...
  IndexObserver__updateSelf_closure0: {
    "^": "Closure:48;this_0,scope_1,key_2",
    call$1: function(changes) {
  ...
  IndexObserver__updateSelf_closure: {
    "^": "Closure:48;this_4,scope_5,key_6",
    call$1: [function(changes) {
  ...
  Parser: {
    ...
    _makeInvokeOrGetter$2: function(left, right) {
      ...
      if (!!t1.$isIdentifier)
        ...
        method = right.get$receiver();
        return new U.Invoke(left, method.get$value(method), right.get$arguments());
      } else
      ...
      if (J.get$kind$x(this._parser$_iterator._current) === 8) {
        ...
        if (t1.$eq(value, "+") || t1.$eq(value, "-")) {
          ...
          if (J.get$kind$x(this._parser$_iterator._current) === 6) {
            value = new U.Literal(H.Primitives_parseInt(H.S(value) + H.S(J.get$value$x(this._parser$_iterator._current)), null, null));
            value.$builtinTypeInfo = [null];
            this._advance$0();
            return value;
          } else if (J.get$kind$x(this._parser$_iterator._current) === 7) {
            value = new U.Literal(H.Primitives_parseDouble(H.S(value) + H.S(J.get$value$x(this._parser$_iterator._current)), null));
            value.$builtinTypeInfo = [null];
            this._advance$0();
            return value;
          } else
    ...
    _parseMapLiteral$0: function() {
      ...
      do {
        ...
        if (J.get$kind$x(this._parser$_iterator._current) === 9 && J.$eq(J.get$value$x(this._parser$_iterator._current), "}"))
          break;
        value = new U.Literal(J.get$value$x(this._parser$_iterator._current));
        value.$builtinTypeInfo = [null];
        this._advance$0();
        this._advance$2(5, ":");
    ...
    _parseString$0: function() {
      var value = H.setRuntimeTypeInfo(new U.Literal(J.get$value$x(this._parser$_iterator._current)), [null]);
      this._advance$0();
      return value;
    },
    _parseInteger$1: function(prefix) {
      var value = H.setRuntimeTypeInfo(new U.Literal(H.Primitives_parseInt(H.S(prefix) + H.S(J.get$value$x(this._parser$_iterator._current)), null, null)), [null]);
      this._advance$0();
      return value;
    },
    ...
    _parseDecimal$1: function(prefix) {
      var value = H.setRuntimeTypeInfo(new U.Literal(H.Primitives_parseDouble(H.S(prefix) + H.S(J.get$value$x(this._parser$_iterator._current)), null)), [null]);
      this._advance$0();
      return value;
    },
...
["template_binding", "package:template_binding/template_binding.dart", , M, {
  ...
  closure2: {
    ...
    }, "call$2", null, 4, 0, null, 98, 70, "call"],
    $isFunction: true
  },
  closure3: {
    "^": "Closure:58;",
  ...
  _getDelegateFactory_closure: {
    "^": "Closure:48;name_0,node_1,delegate_2",
  ...
  _parseAttributeBindings_closure: {
    "^": "Closure:66;box_0,element_1,delegate_2,isTemplateNode_3",
    call$2: function($name, value) {
  ...
  _TemplateIterator: {
    ...
    }, "call$1", "get$_updateIfValue", 2, 0, 13, 122],
    _updateIteratedValue$1: [function(value) {
      ...
      this._updateValue$1(value);
    }, "call$1", "get$_updateIteratedValue", 2, 0, 13, 14],
    ...
    _handleSplices$1: function(splices) {
      var delegate, model, instance, e, s, t1, template, t2, delegate0, instanceCache, t3, removeDelta, splice, t4, t5, model0, instance0, addIndex, exception, t6, t7, previousInstanceLast, $parent;
      ...
      for (t3 = H.setRuntimeTypeInfo(new H.ListIterator(splices, splices.length, 0, null), [H.getTypeArgumentByIndex(splices, 0)]), t4 = this._instances; t3.moveNext$0();) {
        splice = t3._current;
        for (t5 = J.getInterceptor$x(splice), addIndex = t5.get$index(splice); J.$lt$n(addIndex, J.$add$ns(t5.get$index(splice), splice.get$addedCount())); ++addIndex) {
          ...
          if (instance == null)
            try {
              ...
              e = t6;
              s = new H._StackTrace(exception, null);
              t6 = new P._Future(0, $.Zone__current, null, null, null, null, null, null);
              t6.$builtinTypeInfo = [null];
              new P._AsyncCompleter(t6).$builtinTypeInfo = [null];
              t7 = e;
              if (t7 == null)
                H.throwExpression(P.ArgumentError$("Error must not be null"));
              if (t6._state !== 0)
                H.throwExpression(P.StateError$("Future already completed"));
              t6._asyncCompleteError$2(t7, s);
              instance = $.get$_emptyInstance();
            }
...
["utf.list_range", "package:utf/src/list_range.dart", , G, {
  "^": "",
  ListRange: {
    "^": "IterableBase;_list_range$_source,_offset,_list_range$_length",
    get$iterator: function(_) {
      var t1 = this._offset;
  ...
  _ListRangeIteratorImpl: {
    "^": "Object;_list_range$_source,_offset,_end",
    get$current: function() {
      return C.JSString_methods.codeUnitAt$1(this._list_range$_source.__interceptors$_string, this._offset);
    },
    moveNext$0: function() {
...
["utf.utf_16_code_unit_decoder", "package:utf/src/utf_16_code_unit_decoder.dart", , Z, {
  ...
  Utf16CodeUnitDecoder: {
    ...
    moveNext$0: function() {
      ...
      else if (value < 56320 && ++t1._offset < t3) {
        nextValue = C.JSString_methods.codeUnitAt$1(t4, t1._offset);
...
C.Symbol_width = new H.Symbol0("width");
...
Isolate.$lazy($, "_allTemplatesSelectors", "TemplateBindExtension__allTemplatesSelectors", "get$TemplateBindExtension__allTemplatesSelectors", function() {
  return C.JSString_methods.$add("template, ", J.map$1$ax(C.Map_05U44.get$keys(), new M.closure0()).join$1(0, ", "));
});
