...
class CoreList extends PolymerElement with ChangeNotifier  {
   ...
   * @default 80
   */
  @reflectable @published double get height => __$height; double __$height = 80.0; @reflectable set height(double value) { __$height = notifyPropertyChange(#height, __$height, value); }
   ...
   * @default null
   */
  @reflectable @published String get selectedProperty => __$selectedProperty; String __$selectedProperty = 'selected'; @reflectable set selectedProperty(String value) { __$selectedProperty = notifyPropertyChange(#selectedProperty, __$selectedProperty, value); }
   ...
   * @default false
   */
  @reflectable @published bool get sync => __$sync; bool __$sync = false; @reflectable set sync(bool value) { __$sync = notifyPropertyChange(#sync, __$sync, value); }
  ...
  @reflectable @observable dynamic get selected => __$selected; dynamic __$selected; @reflectable set selected(dynamic value) { __$selected = notifyPropertyChange(#selected, __$selected, value); }
