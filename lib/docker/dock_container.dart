...
class DockContainer extends DockableContainerIF {
  ...
  bool _commonDocker(DockContainerBase newContainer, DockContainerBase adjacantContainer, bool arg_horizontal, bool after) {
    ...
    if (_nodes.length < 2 || vertical == arg_horizontal) {
      ...
      if(_nodes.length == 0) {
        ...
        if(adjacantContainer == null && isRoot) {
          ...
          vertical = arg_horizontal;
          DockContainer tC = new Element.tag('dockable-container');
          ...
          DockContainer newCont = new Element.tag('dockable-container');
          //TODO: adjust weights on all newly created DCs
